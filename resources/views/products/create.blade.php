...
<div class="container">
    <div class="page-header">
        <h1 class="page-title"><i class="fa-solid fa-plus-circle me-2"></i> Add New Product</h1>
        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="col-12 form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="Full product specifications and details">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="col-4 form-group">
                    ...
                    <input type="number" step="0.01" name="final_price" id="final_price" class="form-control" value="{{ old('final_price') }}" placeholder="Auto-calculated if blank">
                </div>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="size" id="size" class="form-control" value="{{ old('size') }}" placeholder="e.g. Medium">
                </div>
